...
- Kickoff window: April 17-30, 2026
- Hiring SLA target: offer decision within 6 weeks from kickoff
...
- [x] Create structured feedback template (no free-form only)
- [x] Enforce reliability/security written signal as mandatory gate
...
- [ ] No candidate advances without completed prior-stage rubric
- [ ] No offer without reliability/security gate completion
- [ ] No process changes without documented owner and timestamp

## 7) Escalation protocol
Escalate to CEO within 24h when any condition below is true:
- Fewer than 10 qualified profiles sourced in first 7 days
- Fewer than 3 screens scheduled by end of Week 2
- Compensation misalignment blocks finalist progression
- Interview capacity gap causes SLA breach > 48h
